...
public class DailyKcalsServiceImplTest {
    ...
    public void generateDailyKcals_shouldThrowException() {
        ...
        assertThrows(KcalsException.class, () -> dailyKcalsService.generateDailyKcals(userConditionDTO3));
        ...
        assertThrows(KcalsException.class, () -> dailyKcalsService.generateDailyKcals(userConditionDTO4));


        UserConditionDTO userConditionDTO5 = new UserConditionDTO(10, Gender.MALE, 183, 183, 85, null, Goal.LOSE, invalidFatPercent);

        assertThrows(KcalsException.class, () -> dailyKcalsService.generateDailyKcals(userConditionDTO5));


        UserConditionDTO userConditionDTO6 = new UserConditionDTO(10, Gender.MALE, 183, 183, 85, Intensity.AVG, null, invalidFatPercent);

        assertThrows(KcalsException.class, () -> dailyKcalsService.generateDailyKcals(userConditionDTO6));
    }
}